...
function collision(bri) {
    switch (bri.className) {
        case "dirt": {
            var dirt_sfx = new Audio("audio/dirt.ogg"); // buffers automatically when created
            dirt_sfx.play();
        ...
        case "clear": {
            var clear_sfx = new Audio("audio/clear.ogg"); // buffers automatically when created
            clear_sfx.play();
        ...
        case "coin": {
            ...
            if (document.getElementById("coin_score").innerHTML == Number(document.getElementById('required_coins').innerHTML)) {
                ...
                var coin_sfx = new Audio("audio/teleport1.ogg"); // buffers automatically when created
                coin_sfx.play();
        ...
        case "teleport": {
            restart = true
            var teleport_sfx = new Audio("audio/teleport.ogg"); // buffers automatically when created
            teleport_sfx.play();
